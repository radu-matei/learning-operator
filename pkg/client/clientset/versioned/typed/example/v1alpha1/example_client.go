...
import (
	...
	"github.com/radu-matei/learning-operator/pkg/client/clientset/versioned/scheme"
...
type ExampleV1alpha1Interface interface {
	...
	SimpleExamplesGetter
}

// ExampleV1alpha1Client is used to interact with features provided by the example.radu-matei.com group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) SimpleExamples(namespace string) SimpleExampleInterface {
	return newSimpleExamples(c, namespace)
}
